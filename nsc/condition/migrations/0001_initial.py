    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ages', nsc.condition.fields.ChoiceArrayField(base_field=models.CharField(choices=[('antenatal', 'Antenatal'), ('newborn', 'Newborn'), ('child', 'Child'), ('adult', 'Adult'), ('all', 'All ages')], max_length=50, verbose_name='age groups'), size=None)),
