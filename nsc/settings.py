...
class Common(Configuration):
    ...
    NOTIFY_TEMPLATE_CONSULTATION_OPEN = get_env("NOTIFY_TEMPLATE_CONSULTATION_OPEN", default=None)
    NOTIFY_TEMPLATE_CONSULTATION_OPEN_COMMS = get_env("NOTIFY_TEMPLATE_CONSULTATION_OPEN_COMMS", default=None)
    ...
    NOTIFY_TEMPLATE_PUBLIC_COMMENT = get_env("NOTIFY_TEMPLATE_PUBLIC_COMMENT", default=None)
    NOTIFY_TEMPLATE_STAKEHOLDER_COMMENT = get_env("NOTIFY_TEMPLATE_STAKEHOLDER_COMMENT", default=None)
    ...
    NOTIFY_TEMPLATE_HELP_DESK_COINFIRMATION = get_env("NOTIFY_TEMPLATE_HELP_DESK_COINFIRMATION", default=None)
