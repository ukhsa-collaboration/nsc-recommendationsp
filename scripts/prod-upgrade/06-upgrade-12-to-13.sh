...
# Upgrade PG 12 -> 13 by setting POSTGRESQL_UPGRADE=copy on the DC and
# flipping the ImageChange trigger from openshift/postgresql:12-el8 to
# openshift/postgresql:13-el8. The SCL init script inside the new pod
# detects the existing PG 12 data dir and runs pg_upgrade in copy mode.
...
FROM_TAG="openshift/postgresql:12-el8"
TO_TAG="openshift/postgresql:13-el8"
FROM_MAJOR="12"
TO_MAJOR="13"
